...
void Syscalls::handle_riscv_ebreak()
{
    ...
    case 0x4:
    {
        std::string path = this->read_user_string(this->iss.regfile.get_reg_untimed(11));
        printf("%s", path.c_str());
        break;
    }
    ...
    {
        iss_reg_t args[3];
        if (this->user_access(this->iss.regfile.get_reg_untimed(11), (uint8_t *)args, sizeof(args), false))
        {
        ...
        this->iss.regfile.set_reg(10, open(path.c_str(), open_modeflags[mode], 0644));

        if (this->iss.regfile.get_reg_untimed(10) == -1)
    ...
    case 0x2:
    {
        this->iss.regfile.set_reg(10, close(this->iss.regfile.get_reg_untimed(11)));
        break;
    }
    ...
    case 0x5:
    {
        ...
        this->iss.regfile.set_reg(10, size);
        break;
    }
    ...
    case 0x7:
    {
        this->iss.regfile.set_reg(10, getchar());
        break;
    }
    ...
    case 0xA:
    {
        ...
        this->iss.regfile.set_reg(10, pos != args[1]);
        break;
    }

    case 0x18:
    {
        int status = this->iss.regfile.get_reg_untimed(11) == 0x20026 ? 0 : 1;

        this->iss.time.get_engine()->quit(status & 0x7fffffff);
    ...
    {
        struct stat buf;
        fstat(this->iss.regfile.get_reg_untimed(11), &buf);
        this->iss.regfile.set_reg(10, buf.st_size);
        break;
    }
    ...
    case 0x100:
    {
        ...
        else
        {
            if (args[1])
            {
                this->iss.traces.get_trace_engine()->add_trace_path(0, path);
            }
            else
            {
                this->iss.traces.get_trace_engine()->add_exclude_trace_path(0, path);
            }
            this->iss.traces.get_trace_engine()->check_traces();
        }
        break;
    }
    ...
    //     if ((value & 1) == 1)
    //     {
    //         this->cycle_count_start = this->iss.clock.get_cycles();
    //     }
    //     break;
    // }
    ...
    //     if ((value & 1) == 1)
    //     {
    //         this->cycle_count += this->iss.clock.get_cycles() - this->cycle_count_start;
    //     }
    ...
    //         return;
    //     }
    //     iss_csr_read(&this->iss, CSR_PCCR(args[0]), &this->iss.regfile.get_reg_untimed(10));
    //     break;
    // }
    ...
    case 0x107:
    {
        ...
        this->iss.traces.get_trace_engine()->set_global_enable(args[0]);
        break;
    }
    ...
    case 0x108:
    {
        ...
        this->iss.regfile.set_reg(10, result);
    ...
    case 0x10A:
    {
        ...
        if (trace == NULL)
        {
            vp::Event *event = this->iss.traces.get_trace_engine()->get_event_from_id(id);
            if (event == NULL)
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        event->dump_value((uint8_t *)&value);
                    }
                }
            }
        }
    ...
    case 0x10E:
    {
        ...
        this->iss.trace.reg_dump = this->iss.regfile.get_reg_untimed(11);
        break;
    }
    ...
    case 0x110:
    {
        ...
        this->iss.trace.str_dump = this->read_user_string(this->iss.regfile.get_reg_untimed(11));
        break;
    }
