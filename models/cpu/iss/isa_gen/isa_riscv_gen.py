...
class Rv32f(IsaSubset):
    ...
    def __init__(self):
        super().__init__(name='rvf', instrs=[
            Insn('------- ----- ----- 010 ----- 0000111', 'flw',       FL('s'),            fast_handler=True, tags=['load', "fload", 'fp_op']),
            Insn('------- ----- ----- 010 ----- 0100111', 'fsw',       FS('s'),            fast_handler=True, tags=['store', 'fp_op']),
...
class Rv32d(IsaSubset):
    ...
    def __init__(self):
        super().__init__(name='rvd', instrs=[
            ...
            Insn('------- ----- ----- 011 ----- 0100111', 'fsd',       FS('d'),            fast_handler=True, tags=['store', 'fp_op']),
...
class Rv32c(IsaSubset):
    ...
    def __init__(self):
        super().__init__(name='rv32c', instrs=[
            ...
            Instr('c.sw',       Format_CS,  '110 --- --- -- --- 00', fast_handler=True, tags=["store"]),
            ...
            Instr('c.swsp',     Format_CSS, '110 --- --- -- --- 10', fast_handler=True, tags=["store"]),
            ...
            Instr('c.fswsp',    Format_FCSS, '111 --- --- -- --- 10', fast_handler=True, tags=["store"], isa_tags=['cf']),
            Instr('c.fsw',      Format_FCS,  '111 --- --- -- --- 00', fast_handler=True, tags=["store"], isa_tags=['cf']),
...
class Rv64c(IsaSubset):
    ...
    def __init__(self):
        super().__init__(name='rv64c', instrs=[
            ...
            Instr('c.sw',       Format_CS,  '110 --- --- -- --- 00', fast_handler=True, tags=["store"]),
            Instr('c.sd',       Format_CSD, '111 --- --- -- --- 00', fast_handler=True, tags=["store"]),
            Instr('c.fsd',      Format_CFSD, '101 --- --- -- --- 00', fast_handler=True, tags=["store"]),
            Instr('c.nop',      Format_CI1, '000 000 000 00 000 01', fast_handler=True),
            Instr('c.addi',     Format_CI1, '000 --- --- -- --- 01', fast_handler=True),
            ...
            Instr('c.add',      Format_CR,  '100 1-- --- -- --- 10', fast_handler=True),
            Instr('c.swsp',     Format_CSS, '110 --- --- -- --- 10', fast_handler=True, tags=["store"]),
            Instr('c.sdsp',     Format_DCSS, '111 --- --- -- --- 10', fast_handler=True, tags=["store"]),
            Instr('c.sbreak',   Format_CI1, '100 000 000 00 000 10'),
            Instr('c.fsdsp',    Format_FCSSD, '101 --- --- -- --- 10', tags=["store"], isa_tags=['cf']),
